    ...
    context "instance variables" do
      ...
      context "start and end dates" do
        it 'takes specified dates' do
          my_controller.build_planning_view_variables(start_date: Date.new(2015, 3, 5),
      ...
      context "margin time" do
        it 'takes into account specified durations' do
          my_controller.build_planning_view_variables(start_date: Date.new(2015, 1, 1),
                                                      end_date: Date.new(2015, 12, 31),
                                                      margin_time_before: 3.months,
                                                      margin_time_after: 1.year)
      ...
      context "nb_of_days" do
        ...
        it 'takes into account leap years' do
          my_controller.build_planning_view_variables(start_date: Date.new(2016, 1, 1),
